...
namespace :blog do
  ...
  FileList["#{Webby.site.template_dir}/blog/*"].each do |template|
    ...
    task name => [:create_year_index, :create_month_index] do |t|
      ...
      page = File.join(dir, File.basename(page)+".erb")
  ...
  # this task is used to create the year index file (blog/2008/index.erb)
  ...
  # this task is used to create the month index file (blog/2008/04/index.erb)
